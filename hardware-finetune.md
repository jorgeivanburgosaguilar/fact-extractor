...
`README.md`'s "Adapting to your hardware" table gives per-VRAM-tier guidance for *running
this project elsewhere* (8–12 GB → 32768 context, 16 GB+ → a larger model, no GPU →
`num_gpu 0`). This section is the complementary question — what we would *do differently*
here, not how to reach parity somewhere else.
